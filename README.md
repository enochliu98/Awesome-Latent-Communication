...
- 2026-08-06: 🚀 Added **DroidSpeak**, **OBF**, **RecursiveMAS**, **Bicameral Model**, **TFlow**, **LCGuard**, **Beyond Tokens** (survey), **When Latent Agents Lie** and **Causal Audit**!
...
| 2024/11 | [**DroidSpeak**: KV Cache Sharing for Cross-LLM Communication and Multi-LLM Serving](https://arxiv.org/abs/2411.02820) | First distributed LLM inference system enabling prefix KV cache reuse across *different* LLMs (of the same architecture), with a study of when cross-model cache sharing affects quality. | - |
...
| 2026/04 | [**OBF**: When Less Latent Leads to Better Relay: Information-Preserving Compression for Latent Multi-Agent LLM Collaboration](https://arxiv.org/abs/2604.13349) | Adapts KV-cache eviction to latent relay (e.g., LatentMAS) and injects a low-rank orthogonal residual of evicted KV states into retained ones; with only 9.9%-20.2% of prompt KV retained, it reaches 97%-120% of full-relay accuracy. | [Code](https://github.com/markli404/When-Less-Latent-Leads-to-Better-Relay) |
| 2026/04 | [**RecursiveMAS**: Recursive Multi-Agent Systems](https://arxiv.org/abs/2604.25917) | Casts the whole multi-agent system as a unified latent-space recursive computation, connecting heterogeneous agents through a lightweight RecursiveLink module for latent thought generation and cross-agent latent state transfer. | - |
| 2026/05 | [**Bicameral Model**: Bidirectional Hidden-State Coupling Between Parallel Language Models](https://arxiv.org/abs/2605.11167) | Couples two frozen LLMs through a trainable interface over intermediate hidden states: both models run in lockstep and condition on each other's activations via a translation network and a learned suppression gate (~1% of combined parameters). | - |
| 2026/05 | [**TFlow**: Good Agentic Friends Do Not Just Give Verbal Advice: They Can Update Your Weights](https://arxiv.org/abs/2605.13839) | Weight-space communication: a learned parameter generator compiles sender agents' hidden states into transient low-rank (LoRA) weight perturbations applied to the receiver, instead of appending token messages to its context. | - |
| 2026/05 | [**LCGuard**: Latent Communication Guard for Safe KV Sharing in Multi-Agent Systems](https://arxiv.org/abs/2605.22786) | Safety layer for KV-based latent communication that learns representation-level transformations before caches are shared, reducing reconstruction-based leakage of sensitive inputs while preserving task semantics. | - |
| 2026/06 | [**Beyond Tokens**: A Unified Framework for Latent Communication in LLM-based Multi-Agent Systems](https://arxiv.org/abs/2606.05711) | Survey organizing the latent-communication literature into a unified framework: WHAT information is communicated, WHICH sender-receiver alignment is used, and HOW the information is fused into the receiver. | - |
| 2026/06 | [**When Latent Agents Lie**: KV-Cache Integrity in Multi-Agent LLM Collaboration](https://arxiv.org/abs/2606.28958) | Studies integrity risks of latent collaboration: a malicious specialist can send a harmless-looking visible commitment while passing a manipulated KV-cache state that steers the coordinator's answer. | - |
| 2026/07 | [**Causal Audit**: Do Latent Channels Actually Communicate? A Causal Audit of Latent Multi-Agent LLM Communication](https://arxiv.org/abs/2607.26773) | Introduces a causal audit with controlled message replacements at the sender-receiver boundary, measuring whether receivers actually use example-specific, sender-supplied latent information. | - |
